...
class CreateShoesProductController extends Controller
{
    /**
    ...
    {
        return view('layouts.createshoesproduct');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('shoes')->with('success', 'Thên sản phẩm mới thành công !');
    }
