            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img  src="../images/img-admin/admin.png" class="user-image img-circle elevation-2" style="object-fit: cover" alt="User Image">
                        <span class="d-none d-md-inline">{{ Auth::user()->name }}</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <!-- User image -->
                        <li class="user-header bg-primary">
                            <img src="../images/img-admin/admin.png" style="width: 150px; height: 150px; object-fit: cover;" class="img-circle elevation-2" alt="User Image">
                            <p>
                                {{ Auth::user()->name }}
