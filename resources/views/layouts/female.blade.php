        ...
        <table class="table border">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img style="width: 150px" src="./images/img-female/{{$female -> image_path}}" alt=""></td>
                    <td>{{$female -> name}}</td>
                    <td>{{$female -> price}}</td>
                    <td style="display: flex; justify-content: space-evenly;">
                            ...
                            <form action="{{ route('delete-female',['id'=> $female->id]) }}" method="POST" onsubmit="returnConfirmDeletr(this)"> 
                                @csrf
                                @method('delete')
