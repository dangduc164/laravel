...
<div class="main py-5">
    <div class="container">
        <h2>Thêm Giầy Thể Thao Mới</h2>
        <form action="{{ route('add-spshoes') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3 mt-3">
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control" rows="5" id="image_path" name="image_path">
            </div>
